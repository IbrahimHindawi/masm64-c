...
cl ..\source\entrypoint.c ..\source\m_vec.c /ZI /Fe:%project_name% %project_name%.obj "C:\Program Files (x86)\Windows Kits\10\Lib\10.0.19041.0\um\x64\kernel32.lib" "C:\Program Files (x86)\Windows Kits\10\Lib\10.0.19041.0\um\x64\user32.lib"  "C:\Program Files (x86)\Windows Kits\10\Lib\10.0.19041.0\um\x64\gdi32.lib" /link /subsystem:console /DEBUG:FULL 
